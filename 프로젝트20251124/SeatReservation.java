...
public class SeatReservation {
	public static void main(String[] args) {
		...
		do {
			...
			System.out.println("원하는 메뉴 글자 (s, r, c, e) 중 하나를 입력하세요. : ");
	...
	public static void reserveSeat(boolean[][] seats) {
		System.out.print("원하는 자석의 행(1 ~ 10)과 열(1 ~ 5) 번호를 입력하세요. (예 : 5 3) : ");
	...
	public static void cancelReservation(boolean[][] seats) {
		System.out.print("취소하고자 하는 좌석의 행(1 ~ 10)과 열(1 ~ 5) 번호를 입력하세요.");
